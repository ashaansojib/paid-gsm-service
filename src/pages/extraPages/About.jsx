...
const About = () => {
  return (
    <div className="my-container text-gray-700">
      ...
      <p>Welcome to O-GsmService!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Online Gsm Service's Website, located at www.o-gsm-service.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use O-GsmService if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing O-GsmService, you agreed to
        use cookies in agreement with the Online Gsm Service's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Online Gsm Service and/or its licensors own the
        intellectual property rights for all material on O-GsmService. All
        intellectual property rights are reserved. You may access this from
        O-GsmService for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from O-GsmService</li>
        <li>Sell, rent or sub-license material from O-GsmService</li>
        <li>Reproduce, duplicate or copy material from O-GsmService</li>
        <li>Redistribute content from O-GsmService</li>
      </ul>
      ...
      <p>
        ...
        Online Gsm Service does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Online Gsm Service,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, Online
        Gsm Service shall not be liable for the Comments or for any liability,
      ...
      <p>
        Online Gsm Service reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Online Gsm Service a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Online Gsm Service; and (d) the
      ...
      <p>
        ...
        e-mail to Online Gsm Service. Please include your name, your
      ...
      <p>
        No use of Online Gsm Service's logo or other artwork will be allowed for

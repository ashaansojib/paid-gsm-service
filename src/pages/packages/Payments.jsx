  ...
  return (
    <div className="py-4 bg-slate-100">
      <div className="my-container">
        <h2 className="flex items-center gap-2 p-2 border text-xl font-semibold text-gray-700">
          <FaSackDollar className="animate-pulse" /> Demo Billing Area
        </h2>
          ...
          <div className="p-3">
            ...
            <label className="grid grid-cols-3 gap-2 border items-center mb-3">
              ...
              <input
                type="text"
                name=""
                className="p-2 col-span-2 w-full text-sm"
                id=""
          ...
          <div className="p-3">
            ...
            <label className="grid grid-cols-3 gap-2 border items-center mb-3">
              ...
              <input
                type="text"
                name=""
                className="p-2 col-span-2 text-sm"
                id=""
                placeholder="Company Name"
              />
            </label>
            <label className="grid grid-cols-3 gap-2 border items-center mb-3">
              ...
              <input
                ...
                className="p-2 col-span-2 text-sm"
                id=""
                placeholder="2224/3333/4442/2222"
              />
            </label>
            <label className="grid grid-cols-3 gap-2 border items-center mb-3">
            ...
            <div className="bg-slate-200 p-2">
              <h2 className="text-xl uppercase">
                Package activated for 12 Months
              </h2>
